...
const translations: Record<Language, Translations> = {
  ...
  te: {
    ...
    welcomeMessage: 'నమస్తే, మరియు స్వాగతం. 🙏 నేను ఆశా, KVNN యొక్క అడ్వాన్స్‌డ్ ఊండ్ హీలింగ్ క్లినిక్స్‌లో మీ సంरక్షణ భాగస్వామిని. మీరు నన్ను గాయం, మా చికిత్సలు, విజిట్ బుకింగ్ లేదా ఏదైనా విషయం గురించి అడగవచ్చు. ఈ రోజు నేను మీకు ఎలా సహాయపడగలను?',
  ...
  return (
    <div className="app-container">
      ...
      <div className={`chat-widget-container ${isOpen ? 'animate-slide-up' : 'hidden'}`}>
            ...
            <div className="message-group">
              ...
              <div className="message-content">
                ...
                <div className="action-buttons">
                  <button className="btn-primary">{t.bookAppointment}</button>
                </div>
              </div>
            </div>
          </div>

          {/* Recommended Questions Section (Continuous Horizontally Moving Marquee) */}
            ...
            <div className="suggestion-pills-track">
              {[...t.suggestionPills, ...t.suggestionPills].map((pillText, idx) => (
                <button 
                  key={idx} 
                  className="pill"
                  onClick={() => setInputValue(pillText)}
                >
        ...
        {/* Separate Footer Input Section (white background) */}
